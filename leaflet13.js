...
var startTime = null, stepInMs = 70, drawCount = 0;
        function animate(timestamp) {
 if(counter>=route.features[0].geometry.coordinates.length)return;
          var progress;
          if (startTime === null){
              startTime = timestamp;
          }
